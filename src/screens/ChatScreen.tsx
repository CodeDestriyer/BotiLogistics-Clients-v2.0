...
export default function ChatScreen({ onClearBadge }: Props) {
  ...
  return (
    <div className="animate-fade-in flex flex-col h-[calc(100vh-4rem)]">
      <div className="bg-navy px-4 pt-6 pb-4 rounded-b-3xl shrink-0">
        <h1 className="text-xl font-bold text-white">Чат з менеджером</h1>
      ...
      <div className="px-4 pb-4 pt-2 bg-gray-50 border-t border-gray-200 shrink-0">
